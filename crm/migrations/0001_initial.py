# Generated by Django 2.0.1 on 2018-01-17 01:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[(0, '近期无报名计划'), (1, '一个月内报名'), (2, '2周内报名'), (3, '已报名')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_type', models.SmallIntegerField(choices=[(0, 'qq'), (1, 'wechat'), (2, 'Phone')], default=0)),
                ('contact', models.CharField(max_length=64, unique=True)),
                ('source', models.SmallIntegerField(choices=[(0, 'QQ群'), (1, '51CTO'), (2, '百度推广'), (3, '知乎')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=64, unique=True)),
                ('menus', models.ManyToManyField(blank=True, null=True, to='crm.Menus')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.fields.related.ForeignKey, to='crm.Student')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
        ...
        migrations.AddField(
            model_name='customerinfo',
            name='referral_name',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='crm.CustomerInfo', verbose_name='推荐人'),
        ),
        migrations.AddField(
